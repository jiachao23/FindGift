...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/FindGift/Public/Admin/css/login.css" media="all">
       	<link rel="stylesheet" type="text/css" href="/FindGift/Public/Admin/css/default_color.css" media="all">
    </head>
    <body>
        <div>
            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form action="<?php echo U('login');?>" method="post" class="login-form">
                        <h3 class="welcome"><img src="/FindGift/Public/Admin/images/logo.png" class="login-logo" />后台管理</h3>
	...
	<!--[if lt IE 9]>
    <script type="text/javascript" src="/FindGift/Public/static/jquery-1.10.2.min.js"></script>
    <![endif]-->
    <!--[if gte IE 9]><!-->
